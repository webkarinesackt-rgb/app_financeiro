          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            <Card className="border border-emerald-100 bg-emerald-50">
              <CardContent className="p-4">
                ...
                <p className="text-base sm:text-xl font-bold text-emerald-700 break-words private">{formatCurrency(income)}</p>
                {incomePct !== null && (
            ...
            <Card className="border border-red-100 bg-red-50">
              <CardContent className="p-4">
                ...
                <p className="text-base sm:text-xl font-bold text-red-600 break-words private">{formatCurrency(expenses)}</p>
                {expensesPct !== null && (
            ...
            <Card className={`border ${balance >= 0 ? 'border-blue-100 bg-blue-50' : 'border-red-100 bg-red-50'}`}>
              <CardContent className="p-4">
                ...
                <p className={`text-base sm:text-xl font-bold break-words private ${balance >= 0 ? 'text-blue-700' : 'text-red-600'}`}>{formatCurrency(balance)}</p>
                {prevBalance !== 0 && (
            ...
            <Card className="border border-amber-100 bg-amber-50">
              <CardContent className="p-4">
                ...
                <p className="text-base sm:text-xl font-bold text-amber-700 break-words private">{formatCurrency(actualIncome)}</p>
                {receivablesTotal > 0 && (
